      ...
      <div id="content">
       ...
       java.sql.Date sqlDate = new java.sql.Date(new java.util.Date().getTime());
        ...
        Statement stmt = conn.createStatement();	
			  ResultSet rs = stmt.executeQuery("Select DISTINCT Status, date from Bet where Status = 'live' and date ='" + sqlDate +"'");
		      ...
		      while(rs.next()){
			   ...
			   if(rs.getString("Status").equals("live") || rs.getDate("date").equals(sqlDate)) {
			    { %>
			  <form method="GET" action="addwin.jsp">
				<input name="win1" type="text" value="<%=wordListOne[rand1]%>" size="5" readonly>
				<input name="win2" type="text" value="<%=wordListTwo[rand2]%>" size="5" readonly>
				<input name="win3" type="text" value="<%=wordListThree[rand3]%>" size="5" readonly>
				<input name="win4" type="text" value="<%=wordListFour[rand4]%>" size="5" readonly>
				<input name="win5" type="text" value="<%=wordListFive[rand5]%>" size="5" readonly>
				<input name="win6" type="text" value="<%=wordListSix[rand6]%>" size="5" readonly>
